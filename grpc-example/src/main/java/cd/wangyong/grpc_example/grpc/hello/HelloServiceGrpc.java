...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cd.wangyong.grpc_example.grpc.hello.HelloRequest,
      cd.wangyong.grpc_example.grpc.hello.HelloReply> getSayMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Say",
      requestType = cd.wangyong.grpc_example.grpc.hello.HelloRequest.class,
      responseType = cd.wangyong.grpc_example.grpc.hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cd.wangyong.grpc_example.grpc.hello.HelloRequest,
      cd.wangyong.grpc_example.grpc.hello.HelloReply> getSayMethod() {
    io.grpc.MethodDescriptor<cd.wangyong.grpc_example.grpc.hello.HelloRequest, cd.wangyong.grpc_example.grpc.hello.HelloReply> getSayMethod;
    if ((getSayMethod = HelloServiceGrpc.getSayMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayMethod = HelloServiceGrpc.getSayMethod) == null) {
          HelloServiceGrpc.getSayMethod = getSayMethod =
              io.grpc.MethodDescriptor.<cd.wangyong.grpc_example.grpc.hello.HelloRequest, cd.wangyong.grpc_example.grpc.hello.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Say"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cd.wangyong.grpc_example.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cd.wangyong.grpc_example.grpc.hello.HelloReply.getDefaultInstance()))
              .setSchemaDescriptor(new HelloServiceMethodDescriptorSupplier("Say"))
              .build();
        }
      }
    }
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void say(cd.wangyong.grpc_example.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<cd.wangyong.grpc_example.grpc.hello.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                cd.wangyong.grpc_example.grpc.hello.HelloRequest,
                cd.wangyong.grpc_example.grpc.hello.HelloReply>(
                  this, METHODID_SAY)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public cd.wangyong.grpc_example.grpc.hello.HelloReply say(cd.wangyong.grpc_example.grpc.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cd.wangyong.grpc_example.grpc.hello.HelloReply> say(
        cd.wangyong.grpc_example.grpc.hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY:
          serviceImpl.say((cd.wangyong.grpc_example.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<cd.wangyong.grpc_example.grpc.hello.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cd.wangyong.grpc_example.grpc.hello.HelloProto.getDescriptor();
    }
